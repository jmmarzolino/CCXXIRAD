...
grep -c "^@" HvRADA2_S8_L008_R1_001.fastq >> $RAD/flowcell_reads
...
grep -c "^@" HvRADP3_S5_L005_R1_001.fastq >> $RAD/flowcell_reads
...
grep -c "^@" HvRADO2_S7_L007_R1_001.fastq >> $RAD/flowcell_reads
...
grep -c "^@" HvRADY3_S6_L006_R1_001.fastq >> $RAD/flowcell_reads
