...
# original graph
p <- ggplot(df2, aes(x=range, y=value, fill=variable)) + geom_bar(stat='identity', position='dodge', width=0.7) + theme_classic() + xlab("Minor Allele Frequency Ranges") + ylab("Proportion") + scale_fill_brewer(palette = "YlOrRd")

# neutral selection function: 2Neu/i
# Ne=population size, u = mutation rate, i=sites
# mutation rate estimated from papers ~2.2*10^-6
# CCXXI population size = 384 individuals * 5300000000 genomic sites * median coverage of 0.0000047 = 9565440
# 9565440 results in line too small so I * 1000 = 9565440000
# sites = 5,300,000,000
...
funct <- function(x) ((9565440000*2*2.2)/(10000000*x)) + 1500
